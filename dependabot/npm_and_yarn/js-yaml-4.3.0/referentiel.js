...
var Referentiel = /** @class */ (function () {
    ...
    Referentiel.prototype.matrixLocale = function () {
        return Referentiel.mult(this.matrixSVGViewbox(), this.matrixOffset(), this.matrixTransformOrigin(), this.matrixTransform(), Referentiel.inv(this.matrixTransformOrigin()), this.matrixBorder(), this.matrixScroll());
    };
    ...
    Referentiel.prototype.matrixScroll = function () {
        if (!(this.reference instanceof HTMLElement))
            return Referentiel.identity();
        var left = this.reference.scrollLeft;
        var top = this.reference.scrollTop;
        return [
            [1, 0, -left],
            [0, 1, -top],
            [0, 0, 1],
